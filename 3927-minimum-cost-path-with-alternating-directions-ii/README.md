<h2><a href="https://leetcode.com/problems/minimum-cost-path-with-alternating-directions-ii">Minimum Cost Path with Alternating Directions II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given two integers <code>m</code> and <code>n</code> representing the number of rows and columns of a grid, respectively.</p>
